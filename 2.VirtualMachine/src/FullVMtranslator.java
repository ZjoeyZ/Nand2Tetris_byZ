...
class FullVMtranslator {
    ...
    public FullVMtranslator(String[] files) {
    ...
    private String parseNextCommand() throws Exception {
        ...
        switch (s) {
            ...
            default: {
                ...
                switch (parts[0]) {
                    case "push":
                        return parsePush(parts[1], parts[2]);
                    case "pop":
                        return parsePop(parts[1], parts[2]);
                    case "label":
                        return "(" + funcName + "$" + parts[1] + ")\n";
                    case "goto":
                        return GOTO(parts[1]);
                    case "if-goto":
                    ...
                    case "function": {
                        funcName = parts[1];
                        return FUNCTION(parts[1], parts[2]);
                    }
                    case "call":
                        return CALL(parts[1], parts[2]);
                    case "return": {
                        return RETURN;
                    }
                    default:
                        throw new Exception("bad command! " + parts[0]);
                }
            }
        }
    }
    ...
    public static void main(String files[]) {
        ...
        FullVMtranslator p = new FullVMtranslator(files);
        String init =
                "@256\n" +
                        "D=A\n" +
                        "@SP\n" +
